...
$ad_id=$_GET['id'];
#echo $ad_id;
$result1=mysqli_query($con, "SELECT * FROM electronics WHERE Ad_id='$ad_id' LIMIT 1");
...
<html>
<head>
<title>Baangbrow - Laptop & Komputer</title>
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active"><a href="electronics.php">Laptop & Komputer</a></li>
