...
$result1=mysqli_query($con, "SELECT * FROM mobiles WHERE Ad_id='$ad_id' LIMIT 1");
...
<html>
<head>
<title>Baangbrow - Handphone</title>
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active"><a href="mobiles.php">Handphone</a></li>
